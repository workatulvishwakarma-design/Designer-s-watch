...
import { ESCORT_WOMENS_UNIFIED_PRODUCTS } from "@/lib/escortCatalog";
import type { UnifiedProduct, SortOption } from "@/lib/products";
import { sortProducts } from "@/lib/products";

const categories = ["All", "Gold", "Silver", "Green", "Blue", "Brown", "Rose Gold", "Black", "Pink", "Purple", "Maroon"];

const ROWS_PER_PAGE = 12;
const COLS_PER_ROW = 3; // 3 columns on desktop grid
const ITEMS_PER_PAGE = ROWS_PER_PAGE * COLS_PER_ROW; // 36 items per page

export default function EscortWomensGrid() {
    const [products] = useState<UnifiedProduct[]>(ESCORT_WOMENS_UNIFIED_PRODUCTS);
