...
export default function MenHero() {
    return (
        <section className="relative bg-[#111110] text-[#FAF8F4] overflow-hidden pt-32 pb-24 md:pt-40 md:pb-0 h-auto md:h-[80vh] flex items-center">
            <GrainOverlay opacity={0.06} />

            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(184,147,90,0.1)_0%,transparent_70%)] pointer-events-none translate-x-1/3 -translate-y-1/3" />
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col md:flex-row items-center h-full">
                ...
                <div className="w-full md:w-1/2 flex flex-col items-start text-left md:pr-12 lg:pr-24 z-20">
                    ...
                    <motion.p
                        ...
                        className="font-dm text-[14px] md:text-[15px] text-white/50 max-w-sm font-light leading-[1.8]"
                    >
                        Precision engineering meets commanding aesthetics. Discover our curated selection of timepieces for the modern man, designed for presence and built for longevity.
                    </motion.p>
                </div>
                ...
                <div className="w-full md:w-1/2 relative h-[400px] md:h-full mt-12 md:mt-0 flex items-center justify-center">
                    ...
                    >
                        <Image
                            ...
                            alt="Men's Collection Featured Watch"
                            fill
