...
export default function LegacyBlock() {
    ...
    return (
        <section ref={containerRef} className="py-24 md:py-36 bg-background text-primaryText relative overflow-hidden">
            <div className="container mx-auto px-6 md:px-12 xl:px-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        <div className="pt-4">
                            <motion.button
                                ...
                                className="pb-1 border-b-[1px] border-primaryText/20 hover:border-primaryText transition-colors font-sans tracking-widest uppercase text-sm"
                            >
                                Discover Our Story
                            </motion.button>
                        </div>
                    ...
                    >
                        <motion.div
                            className="absolute inset-0 bg-accent/20 z-10 origin-left"
                            initial={{ scaleX: 1 }}
