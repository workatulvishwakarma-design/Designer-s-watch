...
const rawCollections: Omit<Collection, "title" | "tagline" | "category" | "featuredImage" | "ctaLabel">[] = [
  ...
  },
  {
    ...
    modelFamilies: ["905", "J905", "807", "853"],
    gender: "Unisex",
  ...
  },
  {
    ...
    modelFamilies: ["809", "826", "843", "867", "821", "753", "829"],
    gender: "Men",
  ...
  },
  {
    slug: "stratos",
    name: "Stratos",
    meaning: "Inspired from the stratosphere, made to push beyond the limits",
    description: "Inspired from the stratosphere, made to push beyond the limits. Bold drum-style chronograph display and aerospace aesthetics define a timepiece crafted for supreme performance.",
    identity: "Aerospace · Limitless · Precision",
    luxuryIdentity: "Stratosphere-inspired avant-garde luxury watch styling",
    modelFamilies: ["916"],
    gender: "Men",
  ...
  },
  {
    ...
    modelFamilies: ["825"],
    gender: "Men",
    heroImage: "/images/new-img/model-2/916/916/916BM.3G.png",
  },
  {
    slug: "oasis",
    name: "Oasis",
...
const COLLECTION_CATEGORIES: Record<string, string> = {
  ...
  stratos: "Performance Collections",
